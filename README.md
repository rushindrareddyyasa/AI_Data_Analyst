...
The project was developed incrementally in multiple stages.
...
Wait for the dataset preview to load.
Enter a natural-language question.
Click Ask AI.
The agent selects the appropriate analysis method.
View the answer, analysis result, visualization, or RAG sources.
Example Questions
What are total sales by region?
...
If the uploaded dataset does not contain employee information:
